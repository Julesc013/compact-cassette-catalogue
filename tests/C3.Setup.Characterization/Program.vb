Module Program
    ...
    Sub Main()
        ...
        RunTest("adjacent Alpha 5 setup bundle loads exact bytes", AddressOf AdjacentBundleLoadsExactBytes)
    ...
    Private Sub RegistryRegistrationUsesClosedValues()
        WithPayload(Sub(root As String, manifestPath As String)
                        ...
                        AssertEqual("1.3.0a5", DirectCast(values("DisplayVersion"), String), "registered display version")
    ...
    Private Sub AdjacentBundleLoadsExactBytes()
        WithPayload(Sub(root As String, manifestPath As String)
                        ...
                        AssertEqual("1.3.0a5", context.Manifest.Label, "bundle release label")
    ...
    Private Sub WrongSetupReleaseIdentityIsRejected()
        WithPayload(Sub(root As String, manifestPath As String)
                        Dim setupPath As String = Path.Combine(root, "SETUP.exe")
                        File.WriteAllText(setupPath, "setup-executable")
                        File.WriteAllText(manifestPath, File.ReadAllText(manifestPath).Replace("label=""1.3.0a5""", "label=""1.3.0"""))
    ...
    Private Function BuildManifest(payload As String) As String
        ...
        builder.AppendLine("  <Product version=""1.3.0"" stage=""Alpha 5"" label=""1.3.0a5"" lane=""win-x86-net40"" architecture=""x86"" framework=""v4.0"" sourceCommit=""0123456789abcdef0123456789abcdef01234567"" />")
