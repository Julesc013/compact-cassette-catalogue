Module Program
    ...
    Private Sub RegistryRegistrationUsesClosedValues()
        WithPayload(Sub(root As String, manifestPath As String)
                        ...
                        AssertEqual("1.3.0a4", DirectCast(values("DisplayVersion"), String), "registered display version")
    ...
    Private Sub AdjacentBundleLoadsExactBytes()
        WithPayload(Sub(root As String, manifestPath As String)
                        ...
                        AssertEqual("1.3.0a4", context.Manifest.Label, "bundle release label")
    ...
    Private Sub WrongSetupReleaseIdentityIsRejected()
        WithPayload(Sub(root As String, manifestPath As String)
                        Dim setupPath As String = Path.Combine(root, "SETUP.exe")
                        File.WriteAllText(setupPath, "setup-executable")
                        File.WriteAllText(manifestPath, File.ReadAllText(manifestPath).Replace("label=""1.3.0a4""", "label=""1.3.0"""))
    ...
    Private Function BuildManifest(payload As String) As String
        ...
        builder.AppendLine("  <Product version=""1.3.0"" stage=""Alpha 4"" label=""1.3.0a4"" lane=""win-x86-net40"" architecture=""x86"" framework=""v4.0"" sourceCommit=""0123456789abcdef0123456789abcdef01234567"" />")
