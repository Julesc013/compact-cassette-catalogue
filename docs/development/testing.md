...
526 exported type/member signatures with
...
document/query/fingerprint resource contract extends it to 526 without changing production
state ownership.

The same reflection mechanism freezes all 478 exported Infrastructure
...
surface to 470 signatures, and the reviewed read-only canonical shadow adapter
extends it to 478. All 98 current characterization scenarios execute
