...
Invoke-RepositoryScript 'test-release-tag.ps1'
...
Invoke-RepositoryScript 'validate-distribution-contract.ps1'
Invoke-RepositoryScript 'test-distribution-contract.ps1'
