...
$csharpVersionAssemblyInfoPath = Join-Path $repositoryRoot 'src\Shared\Generated\VersionAssemblyInfo.g.cs'
$updateBranchesPath = Join-Path $repositoryRoot 'src\Shared\Generated\UpdateBranches.g.vb'
$csharpUpdateBranchesPath = Join-Path $repositoryRoot 'src\Shared\Generated\UpdateBranches.g.cs'
...
[IO.File]::WriteAllText($csharpVersionAssemblyInfoPath, $csharpVersionAssemblyInfo, $utf8WithoutBom)
[IO.File]::WriteAllText($updateBranchesPath, $updateBranches, $utf8WithoutBom)
[IO.File]::WriteAllText($csharpUpdateBranchesPath, $csharpUpdateBranches, $utf8WithoutBom)
