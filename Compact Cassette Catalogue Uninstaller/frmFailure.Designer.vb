...
Partial Class frmFailure
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblHeadingFailure.Text = "Compact Cassette Catalogue Uninstaller was interrupted"
        '
        'lblFailure
        '
        ...
        Me.lblFailure.Text = "Compact Cassette Catalogue uninstallation was interrupted. The program may not have been fully uninstalled. Please run the uninstallation again. Click the finish button to exit the uninstaller."
        '
        'pnlButtons
        '
